  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    //      widget: AddEmployeWidget(),
          buttonItem: ButtonItem(
            ...
            enabled: true,
            routeName: RouteConstants.DRIVER_ADD_ROUTE, onPress: () {  
               ref.read(AppbarTitleProvider.appbarTitleProvider).setTitle(AppLocalizations.of(context)!.driver_add_bar_title);
               context.go(RouteConstants.DRIVER_ADD_ROUTE);
            },
          ),
        ),
        allModelWidget: MainPageWidget(
 //         widget: AllEmployeWidget(),
          buttonItem: ButtonItem(
            AppLocalizations.of(context)!.add_all,
            tooltipText: AppLocalizations.of(context)!.tooltip_all,
            enabled: true,
            routeName: RouteConstants.DRIVER_ALL_ROUTE, onPress: ()  async { 
             ref.read(AppbarTitleProvider.appbarTitleProvider).setTitle(AppLocalizations.of(context)!.driver_all_bar_title);
              context.go(RouteConstants.DRIVER_ALL_ROUTE); },
          ),
        ),
...
class DriverPage extends MainPage {
  const DriverPage({
    super.key,
