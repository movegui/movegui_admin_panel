...
late FocusNode _descriptionFocusNode;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Responsive.isDesktop(context)
          ? AdminPanelAppBarDesktop(title: 'Ajouter un Pressing')
          : AdminPanelAppBar(title: 'Ajouter un Pressing'),
      drawer: SideMenu(),
      body: Builder(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  CustomTextField(
                                                    hasIcon: false,
                                                    hintText:
                                                        'Veuillez saisir le nom du Pressing',
                                                    isNumber: false,
                                                  ...
                                                  CustomTextField(
                                                    hasIcon: false,
                                                    hintText:
                                                        'Veuillez saisir la description du pressing',
                                                    isNumber: false,
                                                    controller:
                                                  ...
                                                  CustomTextField(
                                                    hasIcon: false,
                                                    hintText:
                                                        'Veuillez saisir l\'adresse du Pressing',
                                                    isNumber: false,
                                                    controller:
                                                        _adresseController,
                                                    textInputAction:
                                                  ...
                                                  CustomTextField(
                                                    hasIcon: false,
                                                    hintText:
                                                        'Veuillez saisir l\'email du Pressing',
                                                    isNumber: false,
                                                    controller:
                                                        _emailController,
                                                    textInputAction:
                                                  ...
                                                  CustomTextField(
                                                    hasIcon: false,
                                                    hintText:
                                                        'Veuillez saisir le telephone du Pressing',
                                                    isNumber: false,
                                                    controller:
                                                        _telephonController,
                                                    textInputAction:
                                                  ...
                                                  CustomTextField(
                                                    hasIcon: false,
                                                    hintText:
                                                        'Veuillez saisir la personne de Contact du Pressing',
                                                    isNumber: false,
                                                    controller:
                                                        _contactController,
                                                    textInputAction:
                                    ...
                                    try {
                                      if (_pickedImage != null) {
                                        ...
                                        if (imageUrl != null) {
                                          ...
                                          showAlertBar(
                                            context,
                                            'Nouveau Pressing Ajouter avec succes!',
                                          );
                                        }
                                      } else {
                                        showBtmAlert(
  ...
  Future<String?> _uploadImageToFirebase() async {
    try {
      ...
      String fileName = 'pressings/${DateTime.now().millisecondsSinceEpoch}.jpg';
