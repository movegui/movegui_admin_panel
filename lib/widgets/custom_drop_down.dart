...
class CustomDropDown<M extends Model, S extends ModelService<M>> extends StatefulWidget {
  const CustomDropDown({super.key, required this.service, required this.onChanged});
...
class CustomDropDownState<M extends Model, S extends ModelService<M>> extends State<CustomDropDown<M, S>> {
  late S service;
  late List<M> myList = [];
  M? dropdownValue ;
